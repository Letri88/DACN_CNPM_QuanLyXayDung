...
namespace DACN_CNPM_QuanLyXayDung.Controllers
{
    public class TasksController : Controller
    {
        ...
        {
            var heThongQlvongDoiDuAnTaiNguyenContext = _context.Tasks.Include(t => t.AssignedUser).Include(t => t.Project).Include(t => t.Stage);
        ...
        public async Task<IActionResult> Create([Bind("TaskId,ProjectId,StageId,AssignedUserId,TaskName,Description,PercentComplete,StartDate,EndDate,Status")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskId,ProjectId,StageId,AssignedUserId,TaskName,Description,PercentComplete,StartDate,EndDate,Status")] Task task)
        {
            if (id != task.TaskId)
            {
                return NotFound();
