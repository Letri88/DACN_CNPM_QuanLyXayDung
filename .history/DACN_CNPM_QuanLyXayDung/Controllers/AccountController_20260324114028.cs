    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(string username, string password, string? returnUrl = "/")
        {
            var user = await _context.Users
                .Include(u => u.Role)
                .FirstOrDefaultAsync(u => (u.Email == username || u.FullName == username) && u.Password == password && u.Status == "Active");
            ...
            ModelState.AddModelError(string.Empty, "Tài khoản hoặc mật khẩu không đúng, hoặc tài khoản đã bị khóa.");
            ViewData["ReturnUrl"] = returnUrl;
